...
hi Folded guifg=#a0a8b0 guibg=#384048 ctermfg=103 ctermbg=234
...
"hi SpellBad gui=undercurl ctermfg=203 ctermbg=none cterm=underline guisp=#FF6C60
hi SpellBad gui=undercurl ctermfg=none ctermbg=52 cterm=none guisp=#FF6C60
...
if version >= 700 " Vim 7.x specific colors
 ...
 hi Search guifg=#000000 guibg=#cae682 ctermfg=none ctermbg=none cterm=underline 
endif

" Syntax highlighting
hi Comment guifg=#7C7C7C ctermfg=8 
hi Atom guifg=#A8FF60 ctermfg=155 
" hi String guifg=#A8FF60 ctermfg=203
hi String guifg=#A8FF60 ctermfg=216
"hi Number guifg=#FF73FD ctermfg=207 
hi Number guifg=#FF73FD ctermfg=211
...
hi Identifier guifg=#C6C5FE ctermfg=12 cterm=NONE
" hi Identifier guifg=#C6C5FE ctermfg=116 cterm=NONE
